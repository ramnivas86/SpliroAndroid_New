    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (mTabViewLayoutId != 0) {
                ...
                ImageView main_tab_image=(ImageView)tabView.findViewById(R.id.main_tab_image);
                main_tab_image.setImageDrawable(TabActivity.drawableList.get(i));
            }
            if (tabView == null) {
            ...
            tabTitleView.setTextColor(getResources().getColorStateList(R.color.tab_txt_selector));
