...
import arya.spliro.custom.datepicker.ArrayWheelAdapter;
import arya.spliro.custom.datepicker.NumericWheelAdapter;
import arya.spliro.custom.datepicker.OnWheelChangedListener;
import arya.spliro.custom.datepicker.WheelView;
...
public class DatePickerDailog extends Dialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.spl_date_picker);
		btnSetDate = (Button) findViewById(R.id.btnSetDate);
		btnCancel = (Button) findViewById(R.id.btnCancel);
        txtHeaderDPD=(TextView)findViewById(R.id.txtHeaderDPD);
	...
	public void callMe(){
		...
		btnset.setText(Mcontex.getString(R.string.Set));
		btncancel.setText(Mcontex.getString(R.string.Cancel));
        btncancel.setTypeface(SpliroApp.getFontLight());
        btnset.setTypeface(SpliroApp.getFontLight());
        txtHeaderDPD.setTypeface(SpliroApp.getFontLight());
		...
		lytdate.addView(year, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT, 1.12f));
		lytdate.addView(month, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT, 1.25f));
		lytdate.addView(day, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT, 1.25f));
		lytdate.addView(time, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,ViewGroup.LayoutParams.MATCH_PARENT, 1.12f));
		lytdate.addView(am_pm, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,ViewGroup.LayoutParams.MATCH_PARENT, 1.25f));
		...
		public void onClick(View v) {
			try {
				...
				if(current.compareTo(user) > 0&&(!showPreDate)){
                    Util.showOkDialog(null,Env.currentActivity.getResources().getString(R.string.msg_Completion_date_validation));
